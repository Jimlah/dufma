...
class AssetController extends Controller
{
    ...
    public function displayBuilding(Request $request, Response $response)
    {
        ...
        $response->view('/dashboard/employee/building', [
            'buildings' => $buildings,
            'category' => $category
        ]);
    }
    ...
    public function displayMachinery(Request $request, Response $response)
    {
        ...
        $response->view('/dashboard/employee/machinery', [
            'machinery' => $machinery,
            'category' => $category
        ]);
    }
    ...
    public function displayVehicle(Request $request, Response $response)
    {
        ...
        $response->view('/dashboard/employee/vehicle', [
            'vehicle' => $vehicle,
            'category' => $category
        ]);
    }
    ...
    public function displayLand(Request $request, Response $response)
    {
        ...
        $response->view('/dashboard/employee/land', [
            'land' => $land,
            'category' => $category
        ]);
    }
    ...
    public function displayOtherAsset(Request $request, Response $response)
    {
        ...
        $response->view('/dashboard/employee/otherAsset', [
    ...
    public function displayEquipment(Request $request, Response $response)
    {
        ...
        $response->view('/dashboard/employee/equipment', [
            'equipment' => $equipment,
            'category' => $category
        ]);
    }
    ...
    public function displayGoods(Request $request, Response $response)
    {
        ...
        $response->view('/dashboard/employee/goods', [
            'goods' => $goods,
            'category' => $category
        ]);
    }
    ...
    public function displayProduct(Request $request, Response $response)
    {
        ...
        $response->view('/dashboard/employee/product', [
            'product' => $product,
            'category' => $category
        ]);
    }
