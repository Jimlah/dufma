var value = JSON.parse($('#value').text())
var created = JSON.parse($('#created').text())
var colors = ["#ffbc00"],
  dataColors = $("#line-chart").data("colors");
...
colors = ["#fa5c7c"];
(dataColors = $("#line-chart-zoomable").data("colors")) &&
  (colors = dataColors.split(","));
options = {
...
colors = ["#39afd1"];
(dataColors = $("#line-chart-annotations").data("colors")) &&
  (colors = dataColors.split(","));
options = {
  annotations: {
    yaxis: [
    ...
    xaxis: [
      ...
      },
      {
        ...
        label: {
          borderColor: "#ffbc00",
          style: { color: "#fff", background: "#ffbc00" },
  ...
  chart: { height: 380, type: "line", id: "areachart-2" },
  colors: colors,
  dataLabels: { enabled: !1 },
...
colors = ["#727cf5"];
(dataColors = $("#line-chart-syncing").data("colors")) &&
  (colors = dataColors.split(","));
var optionsline2 = {
    chart: { type: "line", height: 160, id: "fb", group: "social" },
    colors: colors,
    stroke: { width: [3], curve: "straight" },
...
chartline2.render();
colors = ["#6c757d"];
(dataColors = $("#line-chart-syncing2").data("colors")) &&
  (colors = dataColors.split(","));
options = {
  chart: { height: 200, type: "line", id: "yt", group: "social" },
  colors: colors,
  dataLabels: { enabled: !1 },
  toolbar: { tools: { selection: !1 } },
  tooltip: {
...
(dataColors = $("#line-chart-missing").data("colors")) &&
  (colors = dataColors.split(","));
options = {
  chart: {
    height: 380,
...
(dataColors = $("#line-chart-dashed").data("colors")) &&
  (colors = dataColors.split(","));
options = {
  chart: { height: 380, type: "line", zoom: { enabled: !1 } },
  dataLabels: { enabled: !1 },
...
for (
  var ts2 = 14844186e5, data = [], spikes = [5, -5, 3, -3, 8, -8], i = 0;
  i < 30;
  i++
) {
...
colors = ["#0acf97"];
(dataColors = $("#line-chart-stepline").data("colors")) &&
  (colors = dataColors.split(","));
options = {
...
function getDayWiseTimeSeries(e, t, a) {
  for (var o = 0; o < t; ) {
    ...
    data.push({ x: r, y: s }), (lastDate = e), (e += 864e5), o++;
  }
}
...
colors = ["#39afd1"];
(dataColors = $("#line-chart-realtime").data("colors")) &&
  (colors = dataColors.split(","));
options = {
  chart: {
    height: 350,
...
window.setInterval(function () {
  ...
  window.setInterval(function () {
    resetData(), chart.updateSeries([{ data: data }], !1, !0);
  }, 6e4);
